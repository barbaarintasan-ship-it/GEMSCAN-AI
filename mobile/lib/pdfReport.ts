...
<title>LuulScan Lab ${t("Identification Report", "Warbixinta Aqoonsiga")}</title>
<style>
...
export async function generateAndSharePdf(
  ...
  if (await Sharing.isAvailableAsync()) {
    await Sharing.shareAsync(shareUri, {
      ...
      UTI: "com.adobe.pdf",
      dialogTitle:
        lang === "so" ? "La wadaag warbixinta LuulScan" : "Share your LuulScan report",
    });
  }
  return { uri: shareUri };
}
