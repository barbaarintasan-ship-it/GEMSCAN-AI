...
<title>GemScan Lab ${t("Artifact Verification Report", "Warbixinta Xaqiijinta Aathaarta")}</title>
<style>
...
export async function generateAndShareArtifactVerificationPdf(
  ...
  const safeName =
    "GemScan-Artifact-Verification-Report-" +
