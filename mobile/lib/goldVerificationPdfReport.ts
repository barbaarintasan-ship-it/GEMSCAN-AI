...
<title>GemScan Lab ${t("Gold Verification Report", "Warbixinta Xaqiijinta Dahabka")}</title>
<style>
...
export async function generateAndShareGoldVerificationPdf(data: GoldVerificationPdfData, lang: Lang): Promise<void> {
  ...
  const safeName =
    "GemScan-Gold-Verification-Report-" +
