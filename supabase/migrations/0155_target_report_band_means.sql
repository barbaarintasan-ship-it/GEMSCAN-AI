-- 0155_target_report_band_means.sql
--
-- Issue 2 (2026-09-24 audit) — surfaces area_spectral_index's new
-- b04_mean/b02_mean (0154) in get_target_report's `spectral` section.
-- Purely additive, same as 0151 itself.
...
begin
  ...
  select jsonb_build_object(
    ...
    'b04_mean', si.b04_mean, 'b02_mean', si.b02_mean
  ) into v_spectral
