...
export interface GeoQuery {
  ...
  // Optional sample context (EMIE): the knowledge providers key off the sample's
  // own field observations when present. Location-only callers omit this — the
  // providers then fall back to mapped lithology + nearby occurrences.
  sample?: {
    hostRocks?: string[];
    lithology?: string[];
    minerals?: string[];
